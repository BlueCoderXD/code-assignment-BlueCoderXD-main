...
public class CommentControllerTest extends IntegrationTest {
    ...
    void listComments() throws Exception {
        mvc.perform((get("/posts/{postId}/comments", 100)))
    ...
    void getCommentDetails() throws Exception {
        mvc.perform((get("/posts/{postId}/comments/{commentId}", 100, 4)))
                .andExpect(status().isOk())
    ...
    void createComment() throws Exception {
        mvc.perform(
                post("/posts/{postId}/comments", 100)
    ...
    void deleteComment() throws Exception {
        mvc.perform(
                delete("/posts/{postId}/comments/{commentId}", 100, 5)
        )
                .andExpect(status().isOk());
    }
